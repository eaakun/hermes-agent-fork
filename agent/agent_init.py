    ...
    if agent.api_mode == "anthropic_messages":
        ...
        if api_key and base_url:
            ...
            if base_url_host_matches(effective_base, "openrouter.ai"):
                ...
                # OpenCode Zen keyless free tier (opencode-free): the SDK would
                # otherwise send ``Bearer <placeholder>`` (401). Override the
                # wire Authorization with an empty value — the Zen relay accepts
                # anonymous requests for free models but 401s any unknown
                # bearer. Backported from v0.20.5.
