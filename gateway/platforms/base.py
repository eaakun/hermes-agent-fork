...
class BasePlatformAdapter(ABC):
    ...
    async def render_progress_card(
        ...
        """Render a rich progress card if the platform supports it.

        Platforms that support rich progress cards (e.g. Feishu Card Kit)
        should override this method to render a card with progress indicators.
        The default implementation returns None, indicating that the caller
        should fall back to plain text progress.
        ...
        Returns:
            SendResult if a card was sent, None to fall back to plain text
        """
        return None
