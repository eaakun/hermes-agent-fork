...
def build_session_context_prompt(
    ...
    *,
    ...
    # Inspiration trigger: a lightweight way to share a spontaneous insight
    # without derailing the current conversation.
    lines.append("")
    lines.append(
        "## Inspiration Trigger\n"
        "If you generate a valuable insight — a non-obvious risk, a missed opportunity,\n"
        "a creative connection — while reasoning or responding, emit it as a\n"
        "<inspiration>Your concise insight here (1-2 sentences)</inspiration>\n"
        "tag in your reply. The system will deliver it to the user asynchronously."
    )
