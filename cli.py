...
class HermesCLI(CLIAgentSetupMixin, CLICommandsMixin, CLIBillingMixin):
    ...
    def process_command(self, command: str) -> bool:
        ...
        elif canonical == "free-pool":
            self._handle_free_pool(cmd_original)
    ...
    def _handle_free_pool(self, cmd_original: str):
        """Show OpenCode Zen free-pool status: live pool, per-model health,
        circuit-break state, cache age, and last full-outage time."""
        try:
            from hermes_cli.free_pool_status import print_free_pool_status
            print_free_pool_status()
