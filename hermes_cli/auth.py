...
class ProviderConfig:
    ...
    # Whether the provider requires a non-empty API key to be usable. Keyless
    # providers (e.g. the backported opencode-free anonymous free tier) set
    # this to False so runtime resolution skips the secret-availability gate
    # and proceeds with an empty bearer token.
...
PROVIDER_REGISTRY: Dict[str, ProviderConfig] = {
    ...
    "opencode-free": ProviderConfig(
        ...
        auth_type="api_key",
        inference_base_url="https://opencode.ai/zen/v1",
        # Keyless/anonymous free tier (backported from v0.20.5): no secret to
        # configure. The endpoint serves free models without a bearer token.
        api_key_env_vars=(),
        base_url_env_var="OPENCODE_FREE_BASE_URL",
