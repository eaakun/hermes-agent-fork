...
def cmd_free_pool(args):
    """Show OpenCode Zen free-pool status (live models, health, circuit-break)."""
    from hermes_cli.free_pool_status import print_free_pool_status

    print_free_pool_status(probe=getattr(args, "probe", False))
...
def main():
    ...
    from hermes_cli.subcommands.free_pool import build_free_pool_parser
    build_free_pool_parser(subparsers, cmd_free_pool=cmd_free_pool)
